...
const FluidTokenIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg viewBox="0 0 100 100" className={className} xmlns="http://www.w3.org/2000/svg">
    <defs>
      <linearGradient id="walletTokenGrad" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" stopColor="#3b82f6" />
        <stop offset="100%" stopColor="#10b981" />
      </linearGradient>
    </defs>
    <path d="M55 20 H90 A5 5 0 0 1 90 35 H55 A5 5 0 0 1 55 20 Z" transform="skewX(-20)" fill="url(#walletTokenGrad)" />
    <path d="M40 42 H85 A5 5 0 0 1 85 57 H40 A5 5 0 0 1 40 42 Z" transform="skewX(-20)" fill="url(#walletTokenGrad)" />
  </svg>
);
                 ...
                 <div className="relative w-[300px] h-[620px] rounded-[3rem] border-[8px] border-[#1a1b26]/50 shadow-2xl overflow-hidden transition-transform duration-500 group-hover:-translate-y-4 backdrop-blur-sm">
                    ...
                    <div className="w-full h-full pt-12 pb-8 px-6 flex flex-col relative bg-[#0f1016]/90">
                        ...
                        <div className="flex-1 space-y-4">
                           ...
                           {[
                              { name: 'Fluid', symbol: 'FLD', amount: '45,000', price: '$45,000', color: 'text-cyan-400', isFluid: true },
                              { name: 'Ethereum', symbol: 'ETH', amount: '12.5', price: '$38,240', color: 'text-blue-400', isFluid: false },
                              { name: 'Tether', symbol: 'USDT', amount: '63,852', price: '$63,852', color: 'text-emerald-400', isFluid: false },
                           ].map((coin, i) => (
                              <div key={i} className="flex items-center justify-between p-3 rounded-xl bg-[#1c1e2b] border border-slate-800/50">
                                 <div className="flex items-center gap-3">
                                    <div className={`w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center font-bold ${coin.color}`}>
                                       {coin.isFluid ? <FluidTokenIcon className="w-6 h-6" /> : coin.symbol[0]}
                                    </div>
                                    <div>
                    ...
                    <div className="w-full h-full pt-12 pb-8 px-6 flex flex-col relative bg-[#0f1016]/90">
                        ...
                        <div className="relative w-full aspect-[1.6/1] rounded-2xl bg-gradient-to-br from-indigo-900 via-purple-900 to-slate-900 p-5 shadow-2xl border-t border-white/10 mb-8 overflow-hidden">
                           ...
                           <div className="flex justify-between items-start mb-6 relative z-10">
                              <FluidTokenIcon className="w-8 h-8" />
